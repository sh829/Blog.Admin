...
export const removeCustom=params=>{
    return axios.delete(`${base}/api/CustomInfo/delete`,{params:params});
};
export const addCustom=params=>{
    return axios.post(`${base}/api/CustomInfo/post`,params);
};
export const editCustom=params=>{
    return axios.put(`${base}/api/CustomInfo/put`,params);
};
//派对咨询信息
export const getPartyAdvisoryInfoListPage=params=>{
    return axios.get(`${base}/api/PartyAdvisoryInfo/get`,{params:params});
};
export const removePartyAdvisoryInfo=params=>{
    return axios.delete(`${base}/api/PartyAdvisoryInfo/delete`,{params:params});
};
export const addPartyAdvisoryInfo=params=>{
    return axios.post(`${base}/api/PartyAdvisoryInfo/post`,params);
};
export const editPartyAdvisoryInfo=params=>{
    return axios.put(`${base}/api/PartyAdvisoryInfo/put`,params);
};
//派对预定信息
export const getPartyBookInfoListPage=params=>{
    return axios.get(`${base}/api/PartyBookInfo/get`,{params:params});
};
export const removePartyBookInfo=params=>{
    return axios.delete(`${base}/api/PartyBookInfo/delete`,{params:params});
};
export const addPartyBookInfo=params=>{
    return axios.post(`${base}/api/PartyBookInfo/post`,params);
};
export const editPartyBookInfo=params=>{
    return axios.put(`${base}/api/PartyBookInfo/put`,params);
};
//参数设置
// 角色管理
